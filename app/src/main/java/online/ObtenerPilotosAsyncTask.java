 ...
 */
public class ObtenerPilotosAsyncTask extends AsyncTask<List<NameValuePair>, Void, List<String>> {

    @Override
    protected List<String> doInBackground(List<NameValuePair>... params) {
        List<String> pilotos = null;
        HttpClient httpClient = HttpClientBuilder.create().build();
        HttpPost httpPost = new HttpPost(String.format("http://roc2.servegame.com/roc/api/pilotos.php"));
        try {
